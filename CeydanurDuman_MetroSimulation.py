...
class MetroAgi:
    ...
    # BFS algoritması kullanarak en az aktarmalı rotayı bulur
        ...
        kuyruk = deque([(baslangic, [baslangic])])  # istasyon ve o ana kadarki yol
        ziyaret_edildi = set()
    ...
    #A* algoritması (Dijkstra gibi) kullanarak en hızlı rotayı bulur
        ...
        # Öncelik kuyruğu: (toplam_sure, id(istasyon), istasyon, yol_listesi)
        ...
        while pq:
            ...
            if mevcut_istasyon.idx in ziyaret_edildi and ziyaret_edildi[mevcut_istasyon.idx] <= toplam_sure:
                continue
            ziyaret_edildi[mevcut_istasyon.idx] = toplam_sure
